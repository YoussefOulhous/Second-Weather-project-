      ...
      >
        <div className="px-16 py-12 flex flex-col">
          <TypeAnimation
            ...
            wrapper="span"
            speed={50}
            className=" text-4xl w-[250px] h-[70px] lg:text-7xl font-poppins sm:w-[400px]  md:w-[400px] lg:w-[450px] xl:w-[450px]  font-semibold tracking-wide sm:text-5xl md:text-6xl dark:text-yellow-400 dark:shadow-xl"
            repeat={Infinity}
          />
          <p className="text-xs mt-5 sm:mt-8 md:mt-20 lg:mt-24 xl:mt-24  text-gray-600 w-[250px] sm:text-xs sm:w-[300px] md:text-sm md:w-[400px] xl:w-[600px] lg:w-[600px] dark:text-white  ">
