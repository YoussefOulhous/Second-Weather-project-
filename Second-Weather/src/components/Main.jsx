    ...
    <div className={`${darkMode && "dark"} bg-white dark:bg-neutral-900`}>
      ...
      >
        <div className="px-16  py-12 flex flex-col">
          ...
          <button
            className="w-40 py-4 mt-10 border-2 bg-neutral-800 rounded-xl text-white hover:bg-slate-950 dark:hover:bg-neutral-900 dark:hover:text-white dark:hover:border-white sm:hover:bg-slate-950  md:hover:bg-slate-950 dark:bg-white dark:text-neutral-900"
            onClick={() => {
